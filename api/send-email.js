...
function createEmailHtml(data) {
  const primaryColor = '#2563eb'; // Biru (sesuaikan jika ingin warna lain)
...
<head>
  ...
  <title>New Contact for Arizal Firdaus Portfolio</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h1>Pesan Baru dari Portfolio Arizal Firdaus</h1>
    </div>
    <div class="content">
      <p>Anda menerima pesan baru melalui form kontak portfolio Arizal Firdaus:</p>
    ...
    <div class="footer">
      <p>Email ini dikirim dari form kontak di website portfolio Arizal Firdaus.</p>
    </div>
  </div>
</body>
</html>
...
export default async function handler(req, res) {
  ...
  const mailOptions = {
    from: `"${name} via Portfolio Arizal Firdaus" <${process.env.EMAIL_USER}>`,
    replyTo: email,
